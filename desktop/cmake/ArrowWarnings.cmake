...
function(arrow_set_warnings target)
    if(MSVC)
...
# ---------------------------------------------------------------------------
if(NOT MSVC AND NOT DEFINED ARROW_FORTIFY_PREDEFINED)
    ...
    check_cxx_source_compiles("
        ...
        #endif
        int main() { return 0; }
    " ARROW_FORTIFY_PREDEFINED)
    unset(CMAKE_REQUIRED_FLAGS)
endif()

function(arrow_set_hardening target)
    ...
    if(ARROW_SANITIZE_ADDRESS OR ARROW_SANITIZE_THREAD)
        return()
    endif()
    ...
    if(MSVC)
        ...
        if(NOT ARROW_FORTIFY_PREDEFINED)
