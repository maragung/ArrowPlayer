...
# is what makes per-port linkage possible at all. Every Arrow triplet includes
...
# compatible build and still run Arrow Player.
set(_arrow_lgpl_dynamic
...
list(FIND _arrow_lgpl_dynamic "${PORT}" _arrow_lgpl_idx)
list(FIND _arrow_register_dynamic "${PORT}" _arrow_reg_idx)

if(_arrow_lgpl_idx GREATER -1 OR _arrow_reg_idx GREATER -1)
...
unset(_arrow_lgpl_idx)
unset(_arrow_reg_idx)

unset(_arrow_lgpl_dynamic)
unset(_arrow_register_dynamic)
