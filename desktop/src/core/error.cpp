...
std::string_view to_string(ErrorCode code) noexcept {
    switch (code) {
        ...
        case ErrorCode::DeviceFormatUnsupported:
            return "DEVICE_FORMAT_UNSUPPORTED";
        case ErrorCode::DeviceLost:
            return "DEVICE_LOST";
        case ErrorCode::ExclusiveModeUnavailable:
            return "EXCLUSIVE_MODE_UNAVAILABLE";
        case ErrorCode::BitPerfectUnavailable:
            return "BIT_PERFECT_UNAVAILABLE";
        ...
        case ErrorCode::MalformedHeader:
        ...
        case ErrorCode::OutputCapExceeded:
            return "OUTPUT_CAP_EXCEEDED";

        case ErrorCode::SchemaViolation:
            return "SCHEMA_VIOLATION";
        case ErrorCode::SchemaVersionTooNew:
            return "SCHEMA_VERSION_TOO_NEW";
        case ErrorCode::AppVersionTooOld:
            return "APP_VERSION_TOO_OLD";
        case ErrorCode::UnknownComponent:
            return "UNKNOWN_COMPONENT";
        case ErrorCode::UnknownBinding:
            return "UNKNOWN_BINDING";
        case ErrorCode::UnknownAction:
            return "UNKNOWN_ACTION";
        case ErrorCode::ContrastBelowFloor:
            return "CONTRAST_BELOW_FLOOR";
        case ErrorCode::ResourceBudgetExceeded:
            return "RESOURCE_BUDGET_EXCEEDED";
        case ErrorCode::ZipSlipDetected:
            return "ZIP_SLIP_DETECTED";
        case ErrorCode::ZipBombDetected:
            return "ZIP_BOMB_DETECTED";
        case ErrorCode::UnsafeSvg:
            return "UNSAFE_SVG";
        case ErrorCode::MissingRequiredFile:
