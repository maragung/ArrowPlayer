...
TEST(PlaybackService, PlaysWavToInjectedSink) {
    ...
    out.write("RIFF", 4); put32(out, 42); out.write("WAVEfmt ", 8); put32(out, 16);
    put16(out, 1); put16(out, 1); put32(out, 44100); put32(out, 88200); put16(out, 2); put16(out, 16);
    out.write("data", 4); put32(out, 2); put16(out, 16384); out.close();
