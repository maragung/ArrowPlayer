...
- [`arrow/version.hpp` — generated](#arrowversionhpp--generated)
...
`.arrowskin` archive passes through them before anything is written, which is
...
## `arrow/version.hpp` — generated

`REQ-BLD-007`. Generated by CMake from `desktop/include/arrow/version.hpp.in`
...
| `version::kName` | `std::string_view` | `"Arrow Player"`. |
